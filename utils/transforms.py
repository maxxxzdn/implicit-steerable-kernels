import torch
from torch_geometric.transforms import BaseTransform, SamplePoints, RandomRotate
...
class RandomRotateAxes(BaseTransform):
    ...
    def __str__(self):
        return 'RandomRotate around axes: ' + ', '.join([str(axis) for axis in self.axes])
