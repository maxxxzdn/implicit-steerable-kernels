...
This file contains the code to generate the synthetic dataset for the N-body problem:
    - Springs: particles connected by springs
    - Charged: particles with charges and electric field
"""
...
class ChargedParticlesSim(object):
    def __init__(
        ...
        loc_std=1.0,
        vel_norm=0.5,
        interaction_strength=[1.0, 1.0, 1.0],
        noise_var=0.0,
        e_z=1.0,
    ):
        """
