...
"""
This script generates the dataset for the N-body problem.
...
if args.simulation == "springs":
    ...
    sim = ChargedParticlesSim(
        ...
        vel_norm=initial_vel_norm,
        e_z=1.0,
        interaction_strength=[1.0, 1.0, args.z_component],
    )
    suffix = "_charged"
else:
...
suffix += (
    str(args.n_balls)
    + "_initvel%d" % args.initial_vel
    + args.suffix
    + "_"
    + str(int(args.z_component))
)
