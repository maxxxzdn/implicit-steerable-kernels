...
from torch_geometric.transforms import RandomTranslate, RandomShear, RandomScale
...
class DatasetAug(Dataset):
    ...
    def __init__(self, dataset, transforms: SequentialTransformation):
        """
        Args:
            dataset (torch_geometric.datasets): The dataset to augment.
